        ...
        <div class="container mx-auto px-4 relative z-10">
            <div class="max-w-3xl">
                ...
                <p class="text-xl text-slate-300 leading-relaxed animate-fade-in-up" style="animation-delay: 0.1s">
                    Hành trình của chúng tôi bắt đầu từ niềm đam mê khám phá và khát khao mang lại những trải nghiệm nghỉ dưỡng đẳng cấp nhất cho mỗi khách hàng.
                </p>
            </div>
        </div>
    </section>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div class="relative">
                    <div class="relative z-10 rounded-[2rem] overflow-hidden shadow-2xl">
                        <img src="https://images.unsplash.com/photo-1571003123894-1f0594d2b5d9?auto=format&fit=crop&q=80&w=1000" alt="Sonata Experience">
                    </div>
                    <!-- Decorative Elements -->
                    <div class="absolute -bottom-10 -right-10 w-64 h-64 bg-blue-600/10 rounded-full blur-3xl -z-10"></div>
                    <div class="absolute -top-10 -left-10 w-48 h-48 bg-slate-900/5 rounded-[2rem] -z-10"></div>
                    
                    <!-- Stats Badge -->
                    <div class="absolute -bottom-6 -left-6 bg-white p-8 rounded-3xl shadow-xl border border-slate-100 hidden md:block">
                ...
                <div>
                    <div class="inline-flex items-center space-x-2 text-blue-600 font-bold tracking-wider uppercase text-sm mb-4">
                    ...
                    <div class="space-y-6 text-slate-600 text-lg leading-relaxed">
                        <p>
                            Được thành lập với sứ mệnh nâng tầm trải nghiệm du lịch Việt, **Sonata Travel** không chỉ đơn thuần là một đại lý đặt phòng. Chúng tôi là người bạn đồng hành, giúp bạn tìm kiếm những không gian sống đẳng cấp và tinh tế nhất.
                        </p>
                        <p>
                            Mỗi khách sạn, mỗi căn phòng trong hệ thống của chúng tôi đều được lựa chọn kỹ lưỡng dựa trên tiêu chuẩn khắt khe về chất lượng dịch vụ, phong cách kiến trúc và sự tiện nghi.
                        </p>
                    </div>
    ...
    <section class="py-24 bg-slate-50">
        <div class="container mx-auto px-4">
            <div class="text-center max-w-2xl mx-auto mb-16">
                ...
                <p class="text-slate-500 text-lg">Chúng tôi cam kết mang lại những giá trị tốt nhất cho hành trình của bạn.</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-10 rounded-[2rem] shadow-sm border border-slate-100 hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
                    ...
                    <p class="text-slate-500 leading-relaxed">Chúng tôi chỉ hợp tác với các đối tác khách sạn đạt tiêu chuẩn 4-5 sao quốc tế.</p>
                </div>
                ...
                <div class="bg-white p-10 rounded-[2rem] shadow-sm border border-slate-100 hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
                    ...
                    <p class="text-slate-500 leading-relaxed">Nhờ mạng lưới đối tác rộng lớn, chúng tôi luôn có mức giá ưu đãi đặc quyền cho khách hàng.</p>
                </div>
                ...
                <div class="bg-white p-10 rounded-[2rem] shadow-sm border border-slate-100 hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
                    ...
                    <p class="text-slate-500 leading-relaxed">Đội ngũ chuyên viên của Sonata luôn sẵn sàng hỗ trợ bạn bất kể thời gian nào trong ngày.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="bg-slate-900 rounded-[3rem] overflow-hidden relative">
                ...
                <div class="relative z-10 p-12 md:p-20 flex flex-col md:flex-row items-center gap-12">
                    <div class="w-32 h-32 rounded-full overflow-hidden border-4 border-white/10 shrink-0">
                        <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=200" alt="Customer">
                    </div>
                    <div>
                        ...
                        <blockquote class="text-2xl text-white font-medium italic mb-6 leading-relaxed">
                            "Dịch vụ của Sonata Travel thật sự vượt ngoài mong đợi. Họ không chỉ tìm cho tôi một căn phòng đẹp, mà còn tư vấn những điểm ăn uống, vui chơi rất tinh tế. Chắc chắn tôi sẽ quay lại."
                        </blockquote>
